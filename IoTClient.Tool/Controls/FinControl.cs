...
{
    public partial class FinControl : UserControl
    {
        private OmronFinsClient omron_client;
        ...
        private void write(string address, int datatype, string value)
        {
            ...
            try
            {
                ...
                switch (datatype)
                {
                    case 0:
                        if (value?.Trim() == "0")
                            result = omron_client.Write(address, false);
                        else if (value?.Trim() == "1")
                            result = omron_client.Write(address, true);
                        break;
                    case 1:
                        result = omron_client.Write(address, byte.Parse(value?.Trim()));
                        break;
                    case 2:
                        result = omron_client.Write(address, short.Parse(value?.Trim()));
                        break;
                    case 3:
                        result = omron_client.Write(address, ushort.Parse(value?.Trim()));
                        break;
                    case 4:
                        result = omron_client.Write(address, int.Parse(value?.Trim()));
                        break;
                    case 5:
                        result = omron_client.Write(address, uint.Parse(value?.Trim()));
                        break;
                    case 6:
                        result = omron_client.Write(address, long.Parse(value?.Trim()));
                        break;
                    case 7:
                        result = omron_client.Write(address, ulong.Parse(value?.Trim()));
                        break;
                    case 8:
                        result = omron_client.Write(address, float.Parse(value?.Trim()));
                        break;
                    case 9:
                        result = omron_client.Write(address, double.Parse(value?.Trim()));
                        break;
                }
                ...
                while (true)
                {
                    ...
                    switch (datatype)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            result = omron_client.ReadByte(address);
                            break;
                        case 2:
                            result = omron_client.ReadInt16(address);
                            break;
                        case 3:
                            result = omron_client.ReadUInt16(address);
                            break;
                        case 4:
                            result = omron_client.ReadInt32(address);
                            break;
                        case 5:
                            result = omron_client.ReadUInt32(address);
                            break;
                        case 6:
                            result = omron_client.ReadInt64(address);
                            break;
                        case 7:
                            result = omron_client.ReadUInt64(address);
                            break;
                        case 8:
                            result = omron_client.ReadFloat(address);
                            break;
                        case 9:
                            result = omron_client.ReadDouble(address);
                            break;
                    }
